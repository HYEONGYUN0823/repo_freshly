...
//	 ----입고관리----
	...
	// 일괄 발주 Ajax
	@RequestMapping("/web/factory/processAllOrderToOrdering")
	public ResponseEntity<Map<String, String>> processAllOrdersToDelivery(@RequestBody Map<String, Integer> needsOrderItems) {
		service.processAllOrdersToDelivery(needsOrderItems);
	    Map<String, String> response = new HashMap<>();
	    response.put("message", "발주 완료");
